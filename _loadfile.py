...
tabler.add_post_hard('Декларация 1', 'Документы','Декларация 1 блок')
tabler.add_post_hard('Декларация 2', 'Документы','Декларация 2 блок')
tabler.add_post_hard('Декларация 3', 'Документы','Декларация 3 блок')
tabler.add_post_hard('Декларация 4', 'Документы','Декларация 4 блок')
